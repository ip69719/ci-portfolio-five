...
def page_cherry_leaf_visualiser_body():
    ...
    if st.checkbox("Image montage"):
        ...
        if st.button("Create Montage"):
            image_montage(dir_path= my_data_dir + '/validation', label_to_display=label_to_display, nrows=3, ncols=3, figsize=(10,12))
...
def image_montage(dir_path, label_to_display, nrows, ncols, figsize=(10,12)):
    ...
    * creates a list of axes indices based on number of rows and number of columns
